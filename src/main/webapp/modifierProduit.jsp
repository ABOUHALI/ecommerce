		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="col-12 grid-margin">
                    ...
                    <form class="form-sample" action="modifierProduit?id_prod=${id}" method="POST" enctype="multipart/form-data">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Nom</label>
                            <div class="col-sm-9">
                              <input type="text" value="${produit.getNom() }" name="nom" class="form-control" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" value="${produit.getQtte() }" name="qte" class="form-control" />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <label class="col-sm-3 col-form-label">Prix</label>
                            ...
                            <input name="prix" value="${produit.getPrix() }" class="form-control" aria-label="Amount (to the nearest dollar)">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <textarea class="col-sm-9" name="description" rows="3" cols="45">${produit.getDescription() }</textarea>
                          </div>
                        </div>
                      </div>
